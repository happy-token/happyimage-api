...
os.environ.setdefault("HAPPYIMAGE_AUTH_KEY", "happyimage")
...
class ImageEditsJsonApiTests(unittest.TestCase):
    ...
    def test_image_edit_accepts_remote_json_url(self):
        ...
        with mock.patch.object(image_inputs_module.requests, "get", return_value=FakeResponse()) as get_mock:
            response = self.client.post(
                "/v1/images/edits",
                headers=AUTH_HEADERS,
                json={"prompt": "支持远程图片链接", "images": [{"image_url": "https://example.com/a.png"}]},
            )
