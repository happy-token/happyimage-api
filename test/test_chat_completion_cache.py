...
class ChatCompletionCacheTests(unittest.TestCase):
    ...
    def test_output_sanitizer_removes_chatgpt_annotation_markup(self) -> None:
        text = (
            "Repo: \ue200url\ue202happy-token/HappyImage"
            "\ue202https://github.com/happy-token/HappyImage\ue201 "
            "details \ue200cite\ue202turn0search0\ue201."
        )

        self.assertEqual(
            sanitize_output_text(text),
            "Repo: happy-token/HappyImage (https://github.com/happy-token/HappyImage) details.",
        )
    ...
    def test_stream_sanitizer_does_not_emit_partial_annotation_or_repeat_prefix(self) -> None:
        events = [
            {"p": "/message/content/parts/0", "o": "append", "v": "Repo: \ue200url\ue202Happy"},
            {"p": "/message/content/parts/0", "o": "append", "v": "Image\ue202turn0search0\ue201 done \ue200cite\ue202turn0\ue201."},
            "[DONE]",
        ]
        ...
        self.assertEqual("".join(deltas), "Repo: HappyImage done.")
